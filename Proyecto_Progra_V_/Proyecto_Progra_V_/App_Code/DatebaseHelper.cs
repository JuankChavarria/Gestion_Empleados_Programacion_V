...
namespace Proyecto_Progra_V_.App_Code
{
    public class DatabaseHelper
    {
        ...
        /// </summary>
        /// <returns>Cadena de conexión para Base de datos.</returns>
        private string GetConnectionString()
        {
            return ConfigurationManager.ConnectionStrings["BD_HospitalSM"].ConnectionString;
        }
